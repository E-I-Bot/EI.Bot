...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '𝗘𝙄.𝖡𝗈𝗍', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '𝗘𝗆𝖻𝗈𝖽𝗂𝖾𝖽𝙄𝘯𝘵𝘦𝘭𝘭𝘪𝘨𝘦𝘯𝘤𝘦 𝖱𝗈𝖻𝗈𝗍', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ei.bot', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 机器人, 具身智能, Robot, Robotics', // 网站关键词 英文逗号隔开
